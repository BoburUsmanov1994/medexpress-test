                    ...
                    <Content sm>
                        ...
                        <div className="grid grid-cols-12 gap-x-10">
                            ...
                            <div className="col-span-8">
                                <div
                                    className={"p-6 rounded-xl shadow-xl drop-shadow-xl border-[3px] border-[rgba(0,0,0,0.1)]"}>
                                    <h4 className={'text-lg font-bold mb-6'}>Д учёт:</h4>
                                    <Form classNames={'grid grid-cols-12 gap-x-6'} formRequest={createEpisodeOfCare} footer={<div className={'col-span-12 '}>
